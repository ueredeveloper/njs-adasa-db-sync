...
async function insertOrUpdateSuperficialSync(grants) {
  ...
  try {
    ...
    const query = `
     INSERT INTO superficial_sync (
          ...
          uh_codigo = EXCLUDED.uh_codigo,

          sup_area_irrigada = EXCLUDED.sup_area_irrigada,
          sup_area_propriedade = EXCLUDED.sup_area_propriedade,
    ...
    for (const grant of grants) {
      const values = [
        ...
        grant.uh_nome,
        grant.uh_codigo,
        grant.sup_area_irrigada,
        grant.sup_area_propriedade,
...
module.exports = insertOrUpdateSuperficialSync;
