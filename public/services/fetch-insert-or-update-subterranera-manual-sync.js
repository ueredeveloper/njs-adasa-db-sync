 ...
 *
 * @async
 * @function fetchInsertOrUpdateSubterraneaManualSync
...
const fetchInsertOrUpdateSubterraneaManualSync = async () => {

     // Make the API request to the backend
     const response = await fetch('http://localhost:3000/services/insert-or-update-subterranea-manual-sync', {
...
export default fetchInsertOrUpdateSubterraneaManualSync;