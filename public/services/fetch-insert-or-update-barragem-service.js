 ...
 *
 * @async
 * @function fetchInsertOrUpdateBarragemService
...
const fetchInsertOrUpdateBarragens = async () => {

     // Make the API request to the backend
     const response = await fetch('http://localhost:3000/services/insert-or-update-barragem', {
...
export default fetchInsertOrUpdateBarragens;