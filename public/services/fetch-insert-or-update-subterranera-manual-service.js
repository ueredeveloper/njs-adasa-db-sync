 ...
 *
 * @async
 * @function fetchInsertOrUpdateSubterraneaManual
...
const fetchInsertOrUpdateSubterraneaManual = async () => {

     // Make the API request to the backend
     const response = await fetch('http://localhost:3000/services/insert-or-update-subterranea-manual', {
...
export default fetchInsertOrUpdateSubterraneaManual;