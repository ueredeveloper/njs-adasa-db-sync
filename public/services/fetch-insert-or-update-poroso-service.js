 ...
 *
 * @async
 * @function fetchInsertOrUpdatePoroso
...
const fetchInsertOrUpdatePoroso = async () => {

    // Make the API request to the backend
    const response = await fetch('http://localhost:3000/services/insert-or-update-poroso', {
...
export default fetchInsertOrUpdatePoroso;