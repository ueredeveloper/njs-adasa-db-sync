 ...
 *
 * @async
 * @function fetchInsertOrUpdateLancPluService
 ...
 * fetchInsertOrUpdateLancPluService(users)
 *   .then((message) => console.log(message))
 *   .catch((error) => console.error(error));
 */

const fetchInsertOrUpdateLancPluService = async () => {

     // Make the API request to the backend
     const response = await fetch('http://localhost:3000/services/insert-or-update-lancamento-pluviais', {
...
export default fetchInsertOrUpdateLancPluService;