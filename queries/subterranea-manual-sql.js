exports.dis_sub_por_query = function (less, grater) {
    return `
    USE SRH;
        SELECT 
        /* usuário */
        ...
        -- Condições: Pertençe aos sistemas poroso (1,2,3,4) e ID INTERFERENCIA ENTRE 1 A 100, por exemplo.
        WHERE SUB.ID_SISTEMA IN (1,2,3,4) AND SUB.ID_SISTEMA IS NOT NULL AND I.ID_INTERFERENCIA >= ${less} AND I.ID_INTERFERENCIA <= ${grater}   
    `
}