...
WHERE 
	...
	--_HG.OBJECTID = 1 AND 
	-- Filtra apenas poços tubulares, porém se não houver nada, trazer os atributos do polígono
	_SUB.ID_SISTEMA IN (1, 2, 3, 4)
	-- Remove processos em análise, indeferidos, obturados e irregular. Porém se não houver nada, trazer os atributos do polígono
